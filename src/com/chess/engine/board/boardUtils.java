...
public class boardUtils {
    ...
    public static final boolean[] SEVENRTH_RANK = initRow(8);
    ...
    private static Map<String, Integer> initializePositionToCoordinateMap() {
        final Map<String, Integer>positionToCoodinate = new HashMap<>();
        for (int i = 0; i<NUM_TILES;i++){
            positionToCoodinate.put(ALGEBREIC_NOTATION[i], i);
        }
        return ImmutableMap.copyOf(positionToCoodinate);
    }
